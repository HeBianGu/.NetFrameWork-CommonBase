...
namespace HeBianGu.Common.Expression
{
    public class ExpressionService
    {
        ...
        {
            var parameters = new ParameterExpression[] { parameter1.Expression, parameter2.Expression };
        ...
        {
            var parameters = new ParameterExpression[] { p1.Expression, p2.Expression, p3.Expression };
        ...
        {
            var parameters = new ParameterExpression[] { p1.Expression, p2.Expression, p3.Expression, p4.Expression };

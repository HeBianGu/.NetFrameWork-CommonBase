...
namespace HeBianGu.Common.Excel
{
    /// <summary>
    ...
    internal class CellConfig
    {
		...
		/// <summary>
		/// If <see cref="Index"/> was not set and AutoIndex is true HeBianGu.Common.Excel will try to autodiscover the column index by its <see cref="Title"/> property.
		/// </summary>

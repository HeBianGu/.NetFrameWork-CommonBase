...
namespace HeBianGu.Common.TestData
{
    ...
    {
        public static string DegreeShort => GetDegreeShort();

        public static string Degree => GetDegree();

        public static string Major => GetMajor();

        public static string SchoolName=> GetSchoolName();

        public static string SchoolGenericName=> GetSchoolGenericName();

        public static string School => GetSchool();
    }

...
namespace HeBianGu.Common.TestData
{
    ...
    {
        public string ZipCode => GetZipCode();

        public string USState => GetUSState();

        public string USStateAbbr => GetUSStateAbbr();

        public string CityPrefix => GetCityPrefix();

        public string CitySuffix=> GetCitySuffix();

        public string City=> GetCity();

        public string StreetSuffix => GetStreetSuffix();

        public string StreetName => GetStreetName();

        public string StreetAddress => GetStreetAddress(true);

        public string SecondaryAddress => GetSecondaryAddress();

        public string UKCounty => GetUKCounty();

        public string UKCountry => GetUKCountry();

        public string UKPostcode => GetUKPostcode();

        public string Neighborhood => GetNeighborhood();
    }
